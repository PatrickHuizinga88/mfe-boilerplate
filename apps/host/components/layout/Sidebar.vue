    ...
    <div class="flex grow flex-col overflow-y-auto border-r border-gray-200 dark:border-zinc-700 px-6 pb-4">
      ...
      <nav class="flex flex-1 flex-col">
        ...
        <ul role="list" class="-mx-2 mt-auto space-y-1">
          <li>
            <button class="w-full hover:bg-gray-900/10 dark:hover:bg-white/10 flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-medium">
...
import { Icon as UiIcon, Logo } from 'ui'
import {
  Dialog,
  DialogPanel,
  TransitionChild,
